...
export const PREGUNTAS: Pregunta[] = [
  ...
  },
  {
    ...
    respuesta:
      "Sí. Despachamos a comercios de todas las provincias por transporte o encomienda. El costo y el plazo dependen del destino y del transporte que elijas; lo coordinamos junto con el pedido.",
  },
  {
    pregunta: "¿En cuánto tiempo llega el pedido?",
    respuesta:
      "Los pedidos con stock se despachan dentro de las 24 a 72 horas hábiles luego de confirmado el pago. El tiempo de tránsito depende del transporte y la provincia de destino.",
  },
  {
