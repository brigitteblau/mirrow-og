...
/** Botón flotante que abre directo el WhatsApp de Mirrow. */
export function WhatsappButton() {
  return (
    ...
    >
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.35)] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:bg-[#20c75a] group-active:scale-95">
